...
(
  ...
  ON DELETE CASCADE,
    CONSTRAINT unique_hourUTC_municipality_branche UNIQUE
(
    hourUTC,
    municipality_id,
    branche_id
...
(
    ...
    CONSTRAINT unique_hourUTC_price_area UNIQUE
(
    hourUTC,
    price_area_id
)
...
(
    ...
    CONSTRAINT unique_hourUTC_price_area_exchange UNIQUE
(
    hourUTC,
    price_area_id
)
